		...
		<div class="row">
			<div class="col-lg-6">
				<div class="screenshots">
					<h1>Screenshots</h1>
					<div id="links">
						<a href="resources/img/senior/screenshot1.jpg"
							title="Screenshot 1" data-gallery> <img
							src="resources/img/senior/screenshot1.jpg" alt="Screenshot 1"
							height="100" width="100">
						</a> <a href="resources/img/senior/screenshot2.jpg"
							title="Screenshot 2" data-gallery> <img
							src="resources/img/senior/screenshot2.jpg" alt="Screenshot 2"
							height="100" width="100">
						</a>
					</div>
				</div>
